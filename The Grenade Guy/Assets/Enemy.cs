...
public class Enemy : MonoBehaviour
{
    ...
    IEnumerator Rotate(int y)
    {
        ...
        if (x > 0)
        {
            ...
            Quaternion target = transform.rotation * Quaternion.Euler(0, 180, 0); //store the target angle we are trying to reach
        ...
        else
        {
            ...
            Quaternion target = Quaternion.Euler(0, 0, 0); //store the target angle we are trying to reach
           // Debug.Log(target);
